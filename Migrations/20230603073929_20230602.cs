    ...
    public partial class _20230602 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Qote", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Qote_Shop_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shop",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopDescription", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopDescription_Shop_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shop",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemPay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemPay_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemPay_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryEmployees_EmployeeId",
                table: "DeliveryEmployees",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryEmployees_OrderId",
                table: "DeliveryEmployees",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopDescription_ShopId",
